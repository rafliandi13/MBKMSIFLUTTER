              ...
              child:  Column(
                ...
                children: [
                        ...
                        children: [
                          ...
                          Container(
                              child: Padding(
                                  ...
                                  child: Text('Pilih CheckBox!',style: TextStyle(color: Colors.red),)
                              )
                          )
                              : Container(),
                        ],
                  ...
                  Container(
                      child: Padding(
                          padding: EdgeInsets.all(10.0),
                          child: Text('Pilih Salah Satu !',style: TextStyle(color: Colors.red),)
                      )
                  )
                      : Container(),
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        ...
                        if (_formKey.currentState!.validate()) {
                          // Process data.
                          if ( (Facebook != true && Twitter != true && Linkedin != true)){
